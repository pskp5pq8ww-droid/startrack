...
const header = () => {
  ...
  return `
    <header class="topbar">
      <button class="brand" data-action="home" aria-label="DepotOS home">
        <img src="./depotos-logo.svg" alt="DepotOS" class="brand-logo" />
...
const homeView = () => `
  <main class="home-screen">
    <button class="logo-admin-btn" data-action="admin-access" aria-label="DepotOS staff login">
      <img src="./depotos-logo.svg" alt="DepotOS" />
    </button>
      ...
      <section class="login-panel">
        <form class="form" data-form="login">
          <div class="view-title">
            <p class="eyebrow">DepotOS · ${roleLabel(state.loginRole)}</p>
            <h2>Sign in</h2>
          </div>
          ${isStaff ? `
  ...
  return `
    ...
    <main class="shell driver-shell">
      <section class="view-head">
        <div class="view-title">
          <p class="eyebrow">DepotOS · Driver</p>
...
const supervisorDashboard = () => {
  ...
  return `
    ...
    <main class="shell">
      <section class="view-head">
        <div class="view-title">
          <p class="eyebrow">DepotOS · Supervisor</p>
          <h2>Daily metrics</h2>
...
const adminView = () => `
  ...
  <main class="shell">
    <section class="view-head">
      <div class="view-title">
        <p class="eyebrow">DepotOS · Admin</p>
